...
class AvenHandler(object):
    pass

class AvenUOM(object):
    """主要是为了生成application中的handlers"""
    module_list = []
        ...
        for module in cls.module_list:
            ...
            for class_ in class_list:
                ...
                for method in method_list:
                    ...
                    # 这里要把httprequest转到avenhandler中必须要有实例
    ...
    def __get_class_list(cls, module):
        ...
        for attr_str in dir_list:
            ...
            if inspect.isclass(attr) and issubclass(attr, AvenHandler):
